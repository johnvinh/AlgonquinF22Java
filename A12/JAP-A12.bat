...
SET MAINCLASSSRC=src/GameController.java
SET MAINCLASSBIN=GameController
...
xcopy %SRCDIR%\gamelogo.png %BINDIR%\

ECHO "1. Compiling ......................"
javac -Xlint %MAINCLASSSRC% -d %BINDIR% > %BINOUT% 2> %BINERR%
